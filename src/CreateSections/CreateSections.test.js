...
const installmentList = [
  ...
  it('renders without crashing', () => {
    ...
    ReactDOM.render(<FanioContext.Provider value={{installmentList: installmentList}}> <CreateSections {...props} /> </FanioContext.Provider>, div);
    ReactDOM.unmountComponentAtNode(div);
  });

  it('renders the UI as expected', () => {
    const tree = renderer
      .create(<FanioContext.Provider value={{installmentList: installmentList}}> <CreateSections {...props} /> </FanioContext.Provider>)
      .toJSON();
