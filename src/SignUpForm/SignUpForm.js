...
export default class SignupForm extends React.Component {
  ...
  handleFullnameChange = (e) => {
    ...
    this.setState({
      ...this.state,
      fullname: { touched: true, value: fullname },
    });
  };
  ...
  handleInterestsChange = (e) => {
    ...
    this.setState({
      ...this.state,
      interests: { touched: true, value: interests },
    });
  };
  ...
  handleEducationChange = (e) => {
    ...
    this.setState({
      ...this.state,
      education: { touched: true, value: education },
    });
  };
  ...
  render() {
    return (
      <form
        onSubmit={(e) => this.props.handleSubmitUser(e, this.state)}
      ...
      >
        ...
        <div className="personal">
          ...
          <input
            defaultValue={this.state.interests.value}
            id="interests"
          ...
          <input
            defaultValue={this.state.education.value}
            id="education"
