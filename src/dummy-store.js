...
const bookList = [
    {id: 1, title: `Harry Potter and the Prisoner of Azkaban`, order: 3, installmentId: 6, reviewId: 21}, 
    {id: 2, title: `Harry Potter and the Philosopher's Stone`, order: 1, installmentId: 6, reviewId: 22}, 
    {id: 3, title: `Harry Potter and the Chamber of Secrets`, order: 2, installmentId: 6, reviewId: null}, 
    {id: 4, title: `Harry Potter and the Case of Jesse's Missing Serotonin`, order: 1, installmentId: 6, reviewId: null}
]
...
const reviewList = [
    ...
    {id: 21, title: `HP1 Review`, content: `fuck JK Rowling fuck JK Rowlingfuck JK Rowlingfuck JK Rowlingfuck JK Rowlingfuck JK Rowlingfuck JK Rowling`, rating: 3}, 
    {id: 22, title: `HP2 Review`, content: `fuck JK Rowling fuck JK Rowlingfuck JK Rowling fuck JK Rowlingfuck JK Rowlingfuck JK Rowlingfuck JK Rowlingfuck JK Rowling`, rating: 3},
    {id: 23, title: `Buffy Comics Season 8 Review`, content: `This is a cool comic book series!`, rating: 3},
    {id: 24, title: `Buffy Comics Season 8 Issue 1 Review`, content: `Look at what I can do! I can create stuff`, rating: 3},
]

const seasonList = [
    {id: 1, title: 'Season 2 Doctor Who', order: 2, reviewId: null, installmentId: 1}, 
    {id: 2, title: 'Season 3 Doctor Who', order: 3, reviewId: null, installmentId: 1}, 
    {id: 3, title: 'Season 1 Doctor Who', order: 1, reviewId: null, installmentId: 1}, 
    {id: 4, title: 'Season 4 Doctor Who', order: 4, reviewId: null, installmentId: 1}, 
    {id: 5, title: 'Season 5 Parks and Recreation', order: 5, reviewId: null, installmentId: 2}, 
    {id: 6, title: 'Season 1 Buffy', order: 1, reviewId: null, installmentId: 3}, 
    {id: 7, title: 'Season 2 Buffy', order: 2, reviewId: null, installmentId: 3}, 
    {id: 8, title: 'Season 1 Supernatural', order: 1, reviewId: 20, installmentId: 5}, 
    {id: 9, title: 'Season 2 Supernatural', order: 2, reviewId: 20, installmentId: 5}, 
    {id: 10, title: 'Season 3 Parks and Recreation', order: 3, reviewId: 18, installmentId: 3}, 
    {id: 11, title: 'Season 3 Supernatural', order: 3, reviewId: 19, installmentId: 5}, 
...
export default {arcList, issueList, installmentList, fandomList, reviewList, seasonList, episodeList, tagList, reviewTagList, bookList, typeList}
